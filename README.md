...
## 🧩 Features
- 🧹 **cleanup.sh** – Removes temporary and unnecessary log files.  
- 💾 **backup.sh** – Creates compressed backups of user data and system directories.  
- 📊 **monitor.sh** – Logs CPU, RAM, and disk usage for performance tracking.  
